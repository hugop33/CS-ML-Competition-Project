...
pivot_data = data.pivot(index='date', columns='traject', values='retard_moyen_arrivee')
...
# Titre et labels
plt.title('Matrice de Corrélation des Retards Moyens entre Différents Trajets', fontsize=15)
