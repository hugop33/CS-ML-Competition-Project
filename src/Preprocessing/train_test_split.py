...
def train_test(df: pd.DataFrame):
    ...
    # 6 derniers mois du dataset i.e données de 2023
    list_test = list_months[-6:]
...
def train_test2(df: pd.DataFrame):
    ...
    y_train = train[["prct_cause_infra", "prct_cause_gestion_trafic", "prct_cause_materiel_roulant",
                     "prct_cause_gestion_gare", "prct_cause_prise_en_charge_voyageurs"]].copy()
    y_test = test[["prct_cause_infra", "prct_cause_gestion_trafic", "prct_cause_materiel_roulant",
                   "prct_cause_gestion_gare", "prct_cause_prise_en_charge_voyageurs"]].copy()
