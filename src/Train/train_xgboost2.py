...
def train2(X_train, y_train, X_test, y_test, **kwargs):
    """
...
def plot_test2(xgb, X_test, y_test):
    """
...
def main():
    ...
    rf = random_forest1(X_train, y_train, X_test, y_test,
                        n_estimators=10000,
                        max_depth=2,
                        learning_rate=0.01,
                        verbosity=2
    ...
    xgb2 = train2(X_train, y_train, X_test, y_test,
                  n_estimators=10000,
                  max_depth=2,
                  learning_rate=0.01,
                  verbosity=2
                  )
    plot_test2(xgb2, X_test, y_test)
